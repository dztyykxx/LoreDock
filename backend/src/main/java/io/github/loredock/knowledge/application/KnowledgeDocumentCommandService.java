 ...
 */
@Service
public class KnowledgeDocumentCommandService implements KnowledgeDocumentCommandUseCase {
    ...
    public KnowledgeDocumentView create(CreateKnowledgeDocumentCommand command) {
        ...
        KnowledgeDocument document = KnowledgeDocument.create(
                UUID.randomUUID(), fields, new DocumentAudit(audit.createdAt(), audit.createdBy()));
