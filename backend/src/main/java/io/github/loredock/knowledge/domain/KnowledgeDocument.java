...
public record KnowledgeDocument(
     ...
     *
     * @param id 服务端生成的文档 UUID
     * @param fields 已校验字段
     * @param audit 创建审计
     * @return 新草稿
     */
    public static KnowledgeDocument create(UUID id, KnowledgeDocumentFields fields, DocumentAudit audit) {
    ...
    KnowledgeDocument publishAsReplacement(UUID oldDocumentId, DocumentAudit audit) {
    ...
    KnowledgeDocument archiveAsReplacedBy(UUID newDocumentId, DocumentAudit audit) {
