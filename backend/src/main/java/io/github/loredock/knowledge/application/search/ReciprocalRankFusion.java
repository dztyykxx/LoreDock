...
public final class ReciprocalRankFusion {
    ...
    public List<FusedKnowledgeSearchCandidate> fuse(
        ...
        Map<UUID, DocumentFusion> documents = new LinkedHashMap<>();
    ...
    private RankedChannel ranked(List<KnowledgeSearchCandidate> candidates) {
        Map<UUID, RankedCandidate> documents = new LinkedHashMap<>();
    ...
    private record RankedChannel(
            Map<UUID, RankedCandidate> documents,
            Map<ChunkKey, RankedCandidate> chunks
    ) {
    }

    private record ChunkKey(UUID documentId, int chunkNo) {
    }
