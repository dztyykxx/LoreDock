 ...
 */
@Component
public class ProjectKnowledgeScopeResolver implements KnowledgeScopeResolver {

    private final ProjectQueryUseCase projectQueries;
    private final AdminProjectQueryUseCase adminProjectQueries;
    ...
    public ProjectKnowledgeScopeResolver(
            ProjectQueryUseCase projectQueries,
            AdminProjectQueryUseCase adminProjectQueries
    ) {
