...
import io.github.loredock.knowledge.mapper.KnowledgeSearchCandidateMapper;
...
public class KnowledgeCandidateDataService {
     ...
     */
    public KnowledgeCandidateDataService(
            KnowledgeSearchCandidateMapper mapper,
            CjkKnowledgeTextAnalyzer analyzer,
    ...
    public List<KnowledgeSearchCandidate> findKeywordCandidates(
    ...
    @Transactional(readOnly = true)
    public List<KnowledgeSearchCandidate> findSemanticCandidates(
            KnowledgeSearchCandidateRequest request,
