...
public class WebQaController {
    private final CreateWebQaQuestionUseCase creates;
    private final QueryWebQaQuestionUseCase queries;
    ...
    public WebQaController(
            CreateWebQaQuestionUseCase creates,
            QueryWebQaQuestionUseCase queries,
