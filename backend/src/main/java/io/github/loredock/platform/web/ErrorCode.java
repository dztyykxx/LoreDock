...
public enum ErrorCode {
    ...
    MEMORY_NOT_FOUND(HttpStatus.NOT_FOUND, "记忆不存在"),
    MEMORY_SCOPE_VIOLATION(HttpStatus.NOT_FOUND, "记忆对当前会话不可达"),
    MEMORY_PROJECT_INVALID(HttpStatus.BAD_REQUEST, "记忆项目不存在或已停用"),
    MEMORY_FIELD_INVALID(HttpStatus.BAD_REQUEST, "记忆字段不合法"),
