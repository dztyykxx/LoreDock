...
import io.github.loredock.code.application.UploadCodeSnapshotCommand;
...
public class AdminCodeSnapshotController {
    ...
    private final CodeSnapshotCommandUseCase commands;
    private final AdminCodeSnapshotQueryUseCase queries;
    ...
    public AdminCodeSnapshotController(
            CodeSnapshotCommandUseCase commands,
            AdminCodeSnapshotQueryUseCase queries
    ) {
    ...
    public CodeSnapshotJobResponse getJob(@PathVariable UUID jobId) {
    ...
    @ResponseStatus(HttpStatus.ACCEPTED)
    public CodeSnapshotJobResponse reindex(@PathVariable UUID snapshotId) {
