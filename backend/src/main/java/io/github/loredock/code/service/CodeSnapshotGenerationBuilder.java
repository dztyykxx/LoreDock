...
public class CodeSnapshotGenerationBuilder {
    ...
    private final CommonsCompressCodeArchiveReader archives;
    private final DefaultCodeFileSelector selector;
    private final FilesystemCodeGenerationPublisher publisher;
    ...
    public CodeSnapshotGenerationBuilder(
            CommonsCompressCodeArchiveReader archives,
            DefaultCodeFileSelector selector,
            FilesystemCodeGenerationPublisher publisher
    ) {
