package io.github.loredock.code.infrastructure.storage;

import io.github.loredock.code.application.CodeSnapshotObjectCompensation;
...
@Component
public class ObjectStorageCodeSnapshotCompensation implements CodeSnapshotObjectCompensation {
