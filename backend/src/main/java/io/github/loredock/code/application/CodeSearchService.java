...
@Service
public class CodeSearchService implements CodeSearchUseCase {

    private final ActiveCodeSnapshotResolver resolver;
    private final CodeIndexSearchPort index;

    /**
     * @param resolver 已启用项目活动范围解析器
     * @param index 固定 generation Lucene 查询端口
     */
    public CodeSearchService(ActiveCodeSnapshotResolver resolver, CodeIndexSearchPort index) {
