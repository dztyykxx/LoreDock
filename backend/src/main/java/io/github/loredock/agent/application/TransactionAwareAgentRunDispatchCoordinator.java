...
@Service
@Slf4j
public class TransactionAwareAgentRunDispatchCoordinator implements AgentRunDispatchCoordinator {

    private final AgentRunScheduler scheduler;
    private final AgentRunDispatchFailureHandler failures;
    ...
    public TransactionAwareAgentRunDispatchCoordinator(
            ...
            AgentRunDispatchFailureHandler failures
    ) {
