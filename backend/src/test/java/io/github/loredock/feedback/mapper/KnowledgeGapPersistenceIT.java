...
import io.github.loredock.feedback.service.KnowledgeGapDataService;
...
class KnowledgeGapPersistenceIT {
    ...
    private static final Long PROJECT_ID = 1360654293921693698L;
    private static final Long BRANCH_ID = 1360654293921693699L;
    ...
    @Autowired private CreateKnowledgeGapService creates;
    @Autowired private ManageKnowledgeGapService manages;
    @Autowired private KnowledgeGapDataService repository;
    ...
    void concurrentAdministratorsConvergeThroughConditionalStatusUpdate() throws Exception {
        Long insertedId = repository.insertIfAbsent(record(1360654293921693713L)).orElseThrow();
        KnowledgeGapFeedbackRecord open = record(insertedId);
    ...
    private io.github.loredock.feedback.model.snapshot.KnowledgeGapFeedbackSnapshot updateAfterBarrier(
            String actor, Long feedbackId, CountDownLatch ready, CountDownLatch start
    ...
    private KnowledgeGapFeedbackRecord record(Long id) {
