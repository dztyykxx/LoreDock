...
class ManageKnowledgeGapServiceTest {
    ...
    void setUp() {
        ...
        service = new ManageKnowledgeGapService(repository, Clock.fixed(NOW, java.time.ZoneOffset.UTC));
    }
    ...
    private KnowledgeGapFeedbackRecord record(
        ...
        return new KnowledgeGapFeedbackRecord(
                0x7700000000000000L + suffix, "member", "key-" + suffix, "a".repeat(64),
                8000000000000000052L, project, 8000000000000000053L, "main", null, null,
    ...
    private static final class MemoryRepository extends KnowledgeGapDataService {
        ...
        @Override public Optional<Long> insertIfAbsent(KnowledgeGapFeedbackRecord feedback) {
        ...
        @Override public Optional<KnowledgeGapFeedbackRecord> findById(Long feedbackId) {
        ...
        @Override public List<KnowledgeGapCitationRecord> findCitations(Long feedbackId) { return List.of(); }
        @Override
        public boolean updateStatus(Long feedbackId, KnowledgeGapStatus expected, KnowledgeGapStatus target,
