...
class AgentRunQueryServiceTest {
    ...
    void eventContinuationBoundsPageAndRejectsNegativeSequence() {
        AgentEventSnapshot event = new AgentEventSnapshot(8000000000000000095L, RUN_ID, 12,
    ...
    private AgentRunSnapshot snapshot(String operator) {
        ...
        return new AgentRunSnapshot(RUN_ID, operator, "key", "a".repeat(64), "project_qa",
                ...
                new AgentScopeSnapshot(8000000000000000096L, "atlas", 8000000000000000097L, "main",
                        8000000000000000098L, "abcdef1", null, List.of("GLOBAL", "PROJECT", "BRANCH")),
