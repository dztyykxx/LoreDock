...
class KnowledgeSearchWebE2EIT {
    ...
    private static final UUID GENERATION_ID = UUID.fromString("81000000-0000-0000-0000-000000000001");
    private static final UUID PROJECT_A = UUID.fromString("81000000-0000-0000-0000-000000000002");
    private static final UUID PROJECT_B = UUID.fromString("81000000-0000-0000-0000-000000000003");
    private static final UUID A_MAIN = UUID.fromString("81000000-0000-0000-0000-000000000004");
    private static final UUID A_OTHER = UUID.fromString("81000000-0000-0000-0000-000000000005");
    private static final UUID B_MAIN = UUID.fromString("81000000-0000-0000-0000-000000000006");
    private static final UUID GLOBAL_DOCUMENT = UUID.fromString("82000000-0000-0000-0000-000000000001");
    private static final UUID PROJECT_DOCUMENT = UUID.fromString("82000000-0000-0000-0000-000000000002");
    private static final UUID BRANCH_DOCUMENT = UUID.fromString("82000000-0000-0000-0000-000000000003");
    private static final UUID OTHER_BRANCH_DOCUMENT = UUID.fromString("82000000-0000-0000-0000-000000000004");
    private static final UUID OTHER_PROJECT_DOCUMENT = UUID.fromString("82000000-0000-0000-0000-000000000005");
    ...
    void repeatedHybridOrderingIsStableAndArchivedTopCandidateIsNotBackfilled() throws Exception {
        ...
        jdbcTemplate.update("""
                ...
                where id=?
                """, Timestamp.from(NOW.plusSeconds(1)), Timestamp.from(NOW.plusSeconds(1)), UUID.fromString(topId));
    ...
    private void seedGeneration() {
        UUID jobId = UUID.fromString("83000000-0000-0000-0000-000000000001");
        jdbcTemplate.update("""
    ...
    private void seedProject(UUID id, String identifier) {
        jdbcTemplate.update("""
    ...
    private void seedBranch(UUID id, UUID projectId, String name) {
        jdbcTemplate.update("""
        ...
        LoginUseCase testLoginUseCase() {
            return command -> {
                if (!"correct-password".equals(command.password())
                        || !("admin".equals(command.username()) || "member".equals(command.username()))) {
                    throw new io.github.loredock.identity.application.InvalidCredentialsException();
                }
                WebRole role = "admin".equals(command.username()) ? WebRole.ADMIN : WebRole.MEMBER;
                return new AuthenticatedActor(command.username(), command.username(), role);
            };
        }
    }
}
