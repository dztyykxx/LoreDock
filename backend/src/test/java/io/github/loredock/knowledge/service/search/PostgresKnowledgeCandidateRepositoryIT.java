...
class PostgresKnowledgeCandidateRepositoryIT {
    ...
    private static final Long GENERATION_ID = 4208371882707910658L;
    private static final Long PROJECT_A = 4208371882707910659L;
    private static final Long PROJECT_B = 4208371882707910660L;
    private static final Long A_MAIN = 4208371882707910661L;
    private static final Long A_FEATURE = 4208371882707910662L;
    private static final Long B_MAIN = 4208371882707910663L;
    ...
    @Autowired
    private KnowledgeCandidateDataService keywordCandidates;

    @Autowired
    private KnowledgeCandidateDataService semanticCandidates;
    ...
    void keywordRankingPrefersTitleAndTagsOverBodyWithStableTieBreak() {
        ...
        List<KnowledgeSearchCandidate> found = keywordCandidates.findKeywordCandidates(globalRequest(50), "恢复");
    ...
    void keywordShortQueryUsesBoundedLiteralFallbackWithoutParsingSyntax() {
        ...
        List<KnowledgeSearchCandidate> found = keywordCandidates.findKeywordCandidates(projectRequest(50), "*");
    ...
    void keywordFiltersRequireAllTagsFormatAndSourceBeforeRanking() {
        ...
        List<KnowledgeSearchCandidate> found = keywordCandidates.findKeywordCandidates(request, "恢复");
    ...
    void keywordScopeIsEnforcedBeforeCandidateLimitAcrossProjectsAndBranches() {
        ...
        List<KnowledgeSearchCandidate> found = keywordCandidates.findKeywordCandidates(projectRequest(2), "隔离");
        List<KnowledgeSearchCandidate> globalFound = keywordCandidates.findKeywordCandidates(globalRequest(50), "隔离");
    ...
    void semanticCandidatesUseExactCosineRankingAndStableTieBreak() {
        Long closest = id(50);
        Long tiedFirst = id(51);
        Long tiedSecond = id(52);
        ...
        List<KnowledgeSearchCandidate> found = semanticCandidates.findSemanticCandidates(
    ...
    void semanticCandidatesRejectWrongVectorDimensionBeforeSqlExecution() {
        ...
        assertThatThrownBy(() -> semanticCandidates.findSemanticCandidates(
    ...
    private void seedProjectsAndGeneration() {
        ...
        jdbcTemplate.update("""
                ...
                values (?, ?, 'ACTIVE', 'BAAI/bge-small-zh-v1.5', ?, 512,
                    'cjk-v1', 'rrf-v1', 0, 0, ?, ?)
    ...
    private void seedDocument(
        ...
        jdbcTemplate.update("""
                insert into knowledge_search_chunk(generation_id, document_id, chunk_no, start_offset, end_offset,
                    content, source_revision, title, tags, wiki_url, original_filename, curation_note,
                    title_terms, tag_terms, content_terms, search_vector, embedding, scope_type,
                    project_id, branch_id, format, source_type, normalized_tags, source_updated_at)
                values (?, ?, 0, 0, ?, ?, 1, ?, cast(? as jsonb), ?, ?, null, ?, ?, ?,
                ...
                title, tagsJson, wikiUrl, filename,
    ...
    private void seedLifecycleOnlyDocument(Long documentId, String status, String title) {
