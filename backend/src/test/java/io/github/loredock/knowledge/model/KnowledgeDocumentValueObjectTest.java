...
class KnowledgeDocumentValueObjectTest {
    ...
    /**
     * 业务目的：GLOBAL、PROJECT、BRANCH 的 Long 组合必须互斥且完整，防止范围字段被静默丢弃或回退。
     */
    @Test
    void scopeRejectsMissingAndResidualIdentifiers() {
        Long projectId = 8000000000000000038L;
        Long branchId = 8000000000000000039L;
    ...
    /**
     * 业务目的：分支范围必须同时保存项目和分支稳定 Long，供应用层继续校验分支归属，禁止用名称拼接伪造范围。
     */
    @Test
    void branchScopeKeepsProjectAndBranchStableIdentifiers() {
        Long projectId = 8000000000000000040L;
        Long branchId = 8000000000000000041L;
