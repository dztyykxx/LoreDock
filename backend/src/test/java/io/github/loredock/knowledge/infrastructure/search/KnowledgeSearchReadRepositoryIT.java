...
class KnowledgeSearchReadRepositoryIT {
    ...
    private static final UUID GENERATION_ID = UUID.fromString("71000000-0000-0000-0000-000000000001");
    private static final UUID PROJECT_A = UUID.fromString("71000000-0000-0000-0000-000000000002");
    private static final UUID PROJECT_B = UUID.fromString("71000000-0000-0000-0000-000000000003");
    private static final UUID A_MAIN = UUID.fromString("71000000-0000-0000-0000-000000000004");
    private static final UUID A_OTHER = UUID.fromString("71000000-0000-0000-0000-000000000005");
    private static final UUID B_MAIN = UUID.fromString("71000000-0000-0000-0000-000000000006");
    ...
    void globalEligibilityRetainsOnlyCurrentlyPublishedGlobalDocumentsInInputOrder() {
        UUID globalSecond = id(11);
        UUID globalFirst = id(10);
        UUID draft = id(12);
        UUID archived = id(13);
        UUID project = id(14);
        ...
        List<UUID> retained = eligibility.retainEligible(
    ...
    void projectEligibilityAppliesCurrentThreeLayerScopeWithoutCrossBranchLeakage() {
        ...
        UUID project = id(21);
        UUID branch = id(22);
        UUID otherBranch = id(23);
        UUID otherProject = id(24);
        UUID archived = id(25);
    ...
    private void seedDocument(UUID id, String status, String scopeType, UUID projectId, UUID branchId) {
    ...
    private UUID id(int suffix) {
        return UUID.fromString("72000000-0000-0000-0000-" + String.format("%012d", suffix));
    }
}
