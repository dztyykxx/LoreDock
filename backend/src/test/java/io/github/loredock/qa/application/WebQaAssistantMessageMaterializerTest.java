...
class WebQaAssistantMessageMaterializerTest {
    private static final UUID QUESTION_ID = UUID.fromString("72000000-0000-0000-0000-000000000001");
    private static final UUID RUN_ID = UUID.fromString("72000000-0000-0000-0000-000000000002");
    ...
    void completedAnswerAndRefusalMaterializeIdempotentAssistantMessages() {
        WebQaMessageRepository messages = mock(WebQaMessageRepository.class);
        when(messages.insertIfAbsent(any())).thenReturn(true, false, true);
    ...
    private WebQaQuestionRecord question() {
        return new WebQaQuestionRecord(QUESTION_ID, "member", "key", "a".repeat(64),
                UUID.randomUUID(), "atlas", UUID.randomUUID(), "main", RUN_ID, NOW);
    }
